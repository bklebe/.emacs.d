...
;; ## added by OPAM user-setup for emacs / tuareg ## df0f8a9bddea6cfa7830461606a36999 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/bea/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
